...
fn calculate_icon_id_effect_desc() {
    ...
    test_icon_id_effect(
        ...
        vec![3727],
        vec![ItemEffect::DamageType(DamageType::Fire)],
        1,
    );
    test_icon_id_effect(
        &parser,
    ...
    test_icon_id_effect(
        ...
        vec![2129],
        vec![ItemEffect::DamageMod(0.04), ItemEffect::KeywordFlatDamageBuff {
            keyword: "NiceAttack".to_string(),
            damage: 5,
            duration: 10,
        }],
    ...
    test_icon_id_effect(
        ...
        vec![3593],
        vec![ItemEffect::DamageTypePerTickDamageBuff {
    ...
    test_icon_id_effect(
        ...
        vec![3045],
        vec![ItemEffect::RestoreArmor(45)],
        0,
    );
    test_icon_id_effect(
        &parser,
    ...
    test_icon_id_effect(
        ...
        vec![3483],
        vec![ItemEffect::RestoreArmor(20)],
        1,
    );
    test_icon_id_effect(
        &parser,
    ...
    test_icon_id_effect(
        ...
        vec![2175],
        vec![ItemEffect::RestoreHealth(7)],
        0,
    );
    test_icon_id_effect(
        &parser,
    ...
    test_icon_id_effect(
        ...
        vec![2176],
        vec![ItemEffect::RestoreArmor(13)],
        0,
    );
    test_icon_id_effect(
        &parser,
    ...
    test_icon_id_effect(
        ...
        vec![3444],
        vec![ItemEffect::DamageMod(0.03), ItemEffect::RestoreHealth(4)],
        0,
    );
    test_icon_id_effect(
        &parser,
